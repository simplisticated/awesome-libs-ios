...
public typealias LibraryDemoViewController_Charts = DemoListViewController
...
extension LibraryDemoViewController_Charts: UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc = vcClass.from(
            nib: .byNibName(name: vcClass.hmr.shortName),
            inBundle: .byInstance(bundle: .current())
        )
