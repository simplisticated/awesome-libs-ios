...
extension LibraryDemoViewController: MKMapViewDelegate {
...
extension LibraryDemoViewController: ClusterManagerDelegate {
...
extension MKMapView {
    func annotationView(selection: LibraryDemoViewController.Selection, annotation: MKAnnotation?, reuseIdentifier: String) -> MKAnnotationView {
        switch selection {
        case .count:
