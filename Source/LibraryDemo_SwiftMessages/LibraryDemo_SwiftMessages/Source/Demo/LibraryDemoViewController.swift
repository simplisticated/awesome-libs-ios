//
//  LibraryDemoViewController.swift
//  LibraryDemo_SwiftMessages
//
//  Created by Visuality on 10.08.2020.
//
...
public class LibraryDemoViewController: UIViewController {
    ...
    private var items: [Item] = [
        .titleBody(title: "MESSAGE VIEW", body: "SwiftMessages provides a standard message view along with a number of layouts, themes and presentation options.", function: LibraryDemoViewController.demoBasics),
        .titleBody(title: "ANY VIEW", body: "Any view, no matter how cute, can be displayed as a message.", function: LibraryDemoViewController.demoAnyView),
        .titleBody(title: "CUSTOMIZE", body: "Easily customize by copying one of the SwiftMessages nib files into your project as a starting point. Then order some tacos.", function: LibraryDemoViewController.demoCustomNib),
        .explore,
        .titleBody(title: "CENTERED", body: "Show cenetered messages with a fun, physics-based dismissal gesture.", function: LibraryDemoViewController.demoCentered),
        .viewController,
        //.counted,
    ]
    ...
    private func setupTableView() {
        self.tableView.register(
            UINib(nibName: "TitleBodyCell", bundle: .SwiftMessages()),
            forCellReuseIdentifier: "TitleBodyCell"
        )
...
extension LibraryDemoViewController: UITableViewDataSource, UITableViewDelegate {
...
extension LibraryDemoViewController {
