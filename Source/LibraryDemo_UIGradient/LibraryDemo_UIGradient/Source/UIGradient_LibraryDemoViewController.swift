...
public class UIGradient_LibraryDemoViewController: UIViewController {
    ...
    func setupGradientViews(gradientPattern: GradientPattern) {
        ...
        lblGradientColors.center.y = self.view.center.y + self.view.frame.width * 4 / 5 / 2 + CGFloat(20)
...
extension UIGradient_LibraryDemoViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
